...
description: |
  ...
  de textos. Transforma textos que apenas informam em textos que analisam, interpretam
  e produzem insight. Atua sobre cinco dimensões: análise, contexto, implicação
